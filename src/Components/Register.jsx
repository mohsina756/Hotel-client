          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <form onSubmit={handleRegister} className="card-body">
              ...
              <div className="form-control mt-6">
                ...
                <button className="btn bg-blue-500 text-white hover:text-black hover:bg-white normal-case ">
                  Register
                </button>
              </div>
            </form>
            <button
              ...
              className=" mb-2 mx-2 btn btn-outline normal-case text-[#29465B] border-none  hover:bg-blue-400 hover:text-black"
            >
              <FcGoogle></FcGoogle>
              Log in with Google
            </button>
